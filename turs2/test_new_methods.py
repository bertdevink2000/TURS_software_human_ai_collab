...
#this file is to test the new methods, it's only a temporary file for the sake of debugging and the like,
#it is mostly the same as run_ad_bench currently.
...
for fold, (train_index, test_index) in enumerate(skf.split(X, y)):
    ...
    ruleset.get_all_rules(max_iter=1000, printing=True)
    end_time = time.time()
